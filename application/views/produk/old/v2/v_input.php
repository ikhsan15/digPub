                ...
                <div class="card-body">
                  <?php echo form_open_multipart('produk/insert'); ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="judul_idn" class="form-control" required>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="kategori_idn">
                          <?php
                            ...
                            <option value="<?php echo $k->kategori_id; ?>"><?php echo $k->nama_kategori_idn; ?> </option>
                          <?php
                            }
                          ?>
                        </select>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="terlaris">
                          <?php
                            ...
                            <option value="<?php echo $k->pilihan_id; ?>"><?php echo $k->pilihan_name; ?> </option>
                          <?php
                            }
                          ?>
                        </select>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="sinopsis_idn" placeholder="Enter text here..."></textarea>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-9">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" name="userfile" onchange="readURL(this);">
                        ...
                        <div class="col-md-3">
                          <br>
                          <img id="cover" class="rounded float-end" src="https://img.icons8.com/wired/64/000000/no-image.png" alt="image cover" />
                        </div>
                      </div>
                    </div>
