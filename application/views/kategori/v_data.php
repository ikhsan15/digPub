          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url('kategori'); ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori</p>
                  </a>
                </li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary shadow-none">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <?php echo form_open_multipart('kategori/formawal/do_save/'.$kategori_id); ?>
                  <!-- <php echo form_open('kategori/formawal/do_save/'.$kategori_id); ?> -->
                    <div class="form-group">
                      <input type="hidden" name="kategori_id" value="<?php echo $kategori_id; ?>">
                    </div>
                    <div class="form-group">
                      <label>Nama Kategori IDN</label>
                      <input type="text" name="kategori_idn" class="form-control" value="<?php echo $kategori_idn; ?>" required>
                    </div>
                    <div class="form-group">
                      <label>Nama Kategori ENG</label>
                      <input type="text" name="kategori_eng" class="form-control" value="<?php echo $kategori_eng; ?>" required>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-9">
                        ...
                        <div class="col-md-3">
                          ...
                          <img id="cover" class="rounded float-end" class="img-thumbnail" width="70%" 
                            <?php
                              if(!empty($recordimg['cover_img'])){
                            ?>
                                src="<?php echo base_url() ?>./gambar/cover_kat/<?php echo $recordimg['cover_img'] ?>"
                            <?php
                              }else{
                            ?>
                    ...
                    <div class="box-footer" align="center">
                      ...
                      <input type="reset" class="btn btn-block btn-outline-warning" style="width:100px;" value="Reset" onclick="location.href='<?php echo base_url('kategori'); ?>'">
                    </div>
                ...
                <div class="card-body">
                  ...
                  <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm " cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>No. </th>
                        <th>Nama Kategori IDN</th>
                        <th>Nama Kategori ENG</th>
                        <th>Cover</th>
                        <th>Cover Size</th>
                        <th>Edit</th>
                        <th>Delete</th>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if(!empty($r->cover_img)){ ?>
                              <img src="<?php echo base_url().'./gambar/cover_kat/'.$r->cover_img; ?>" class="img-thumbnail" width="70px" height="70px">
                            <?php }else{ ?>
                          ...
                          <td><?php echo anchor('kategori/formawal/do_update/'.$r->kategori_id, 'Edit')?></td>
                          <td><?php echo anchor('kategori/formawal/do_delete/'.$r->kategori_id, 'Delete') ?></td>
                        </tr>
                      <?php
                          $no++;
                        }
